...
# Render үшін веб-сервер (порт талабын қанағаттандыру үшін)
app = Flask(__name__)
...
def handle_callback(call):
  ...
  if call.data in symbol_map:
    ...
    try:
      ...
      bot.send_message(
          call.message.chat.id, "❌ Деректерді алу мүмкін болмады."
      )


if __name__ == "__main__":
  # Flask-ті бөлек ағында (thread) қосамыз
